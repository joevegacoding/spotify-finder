...
import { TracksList, SectionWrapper } from "../components";
...
const PlaylistInfoPage = () => {
  ...
  useEffect(() => {
    ...
    //this updates the audiofeatures state using the track's id
...
//this functions sorts tracks by audio features
    ...
    <>
      {playlist && (
        <>
          ...
          <main>
            <SectionWrapper title="Tracks" breadcrumb={true}>
            <StyledDropdown  active={!!sortValue}>
              ...
              {sortedTracks && <TracksList tracks={sortedTracks} />}
            </SectionWrapper>
          </main>
        </>
      )}
